...
import Classpackage.HRDetails;
import javax.swing.JOptionPane;

public class HRManagementLogin extends javax.swing.JFrame {

    /**
     * Creates new form HRLogin
     */
    public HRManagementLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(HID, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(HPass, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(97, 97, 97))
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        if(HID.getText().isEmpty()|HPass.getText().isEmpty())
      {
      ...
      else
      {
          ...
          HRDetails hr = new HRDetails(hID, hPass);
          
          if(hr.validateLogin())
          {
              JOptionPane.showMessageDialog(null,"Login successfull","Login Form",JOptionPane.INFORMATION_MESSAGE);
          ...
          {
              JOptionPane.showMessageDialog(null, "login Failed ","Login form",JOptionPane.ERROR_MESSAGE);
          }
      }
...
JOptionPane.showMessageDialog(rootPane,"Back to Main Menu","Information",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HRManagementLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HRManagementLogin().setVisible(true);
            }
        });
    }
